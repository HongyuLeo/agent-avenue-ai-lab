...
Download `AgentAvenueAI-Public-v2.1.0-Windows.zip`, extract the whole archive, and run `AgentAvenueAI.exe`.

This unsigned community build may trigger Windows SmartScreen. SHA-256 checksums and complete runtime notices are included in the archive.
